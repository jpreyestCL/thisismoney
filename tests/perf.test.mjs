...
assert.match(html, /function cycleFpsCap\(/);
assert.match(html, /tim_fpscap/);
assert.match(html, /data-act="fps"/);
...
assert.match(html, /Mañana\. El sol sale: dura 1 minuto/);
assert.match(html, /Tarde\. El sol baja durante 2 minutos y medio/);
assert.match(html, /function dayPart|dayPart\(/);
